...
# ==========================================
if df_history.empty:
    st.warning(f"{selected_season} のデータが見つかりません。CSVファイルまたは公式サイトのデータを確認してください。")
else:
    # --- 集計処理 ---
